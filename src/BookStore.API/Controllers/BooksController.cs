...
namespace BookStore.API.Controllers
{
    ...
    public class BooksController : MainController
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            return Ok(_mapper.Map<IEnumerable<BookResult>>(books));
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Ok(_mapper.Map<BookResult>(book));
        }
        ...
        public async Task<IActionResult> Add(BookAdd bookDto)
        {
            ...
            return Ok(_mapper.Map<BookResult>(bookResult));
        }
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Update(int id, BookEdit bookDto)
        {
