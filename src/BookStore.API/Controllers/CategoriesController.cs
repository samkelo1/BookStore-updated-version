...
namespace BookStore.API.Controllers
{
    ...
    public class CategoriesController : MainController
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            return Ok(_mapper.Map<IEnumerable<CategoryResult>>(categories));
        }
        ...
        public async Task<IActionResult> Add(CategoryAdd categoryDto)
        {
            ...
            return Ok(_mapper.Map<CategoryResult>(categoryResult));
        }
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Update(int id, CategoryEdit categoryDto)
        {
